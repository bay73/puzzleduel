...
test('Solver controllers',(suite) => {
  ...
  assert("Empty cell chooser").that(puzzle.cells[2][2].chooserValues).containsAtLeast([{},{text: '1', returnValue: '1'},{text: '2', returnValue: '2'},{text: '3', returnValue: '3'},{text: '4', returnValue: '4'},{text: '5', returnValue: '5'},{text: '9', returnValue: '9'},{image: "cross"}]);
...
test('Author controllers',(suite) => {
  ...
  assert("Cell chooser").that(puzzle.cells[0][0].chooserValues).containsAtLeast([{},{text: '1', returnValue: '1'},{text: '2', returnValue: '2'},{text: '3', returnValue: '3'},{text: '4', returnValue: '4'},{text: '5', returnValue: '5'},{text: '9', returnValue: '9'}]);
