fencePentominoTestSuite = testSuite("Pentomino Fences",
...
test('Process click on edge',(suite) => {
  let puzzle = suite.showPuzzle("fence_pentomino", "4x4",{"b1": "0", "a2": "3"});
  puzzle.start();
...
test('Data collector',(suite) => {
  let puzzle = suite.showPuzzle("fence_pentomino", "4x4",{"a1": "3", "b2": "3", "c1": "0", "d2": "1"});
  puzzle.start();
