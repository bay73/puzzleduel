...
sudokuPuzzleType.prototype.setTypeProperties = function(typeCode) {
  ...
  if (typeCode=="sudoku_skyscrapers") {
    ...
    this.typeProperties = decribePuzzleType()
      .add(controller().forAuthor().cell().chooser()
        .addNumbers(1, maxValue)
        .addItem(StdItem.GREY_ARROW_U)
        .addItem(StdItem.GREY_ARROW_R)
        .addItem(StdItem.GREY_ARROW_D)
        .addItem(StdItem.GREY_ARROW_L))
      .add(controller().forSolver().cell().inner().noClue().chooser()
        .addNumbers(1, maxValue))
      .add(controller().forSolver().cell().inner().clue(StdItem.GREY_ARROW_U, StdItem.GREY_ARROW_R, StdItem.GREY_ARROW_D, StdItem.GREY_ARROW_L).chooser()
        .addNumbers(1, maxValue, StdColor.STANDARD))
      .addUpgradeClue(clue=>clue=="white"?null:clue)
      .build(this);
